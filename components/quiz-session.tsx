        ...
        <div className="page quiz-layout">
            ...
            {currentIndex + 1} / {items.length}
                ...
                <div className="quiz-card">
                    <div style={{display: "flex", alignItems: "center", gap: 10, marginBottom: 14}}>
                        <span className="docno">{item.docNo}</span>
              ...
              {cat.name} · 第二層工程項目
                ...
                {existing.skipped
                    ...
                    <h2
                        className="zh text-heading"
                        style={{margin: "0 0 22px", color: "var(--fg-primary)"}}
                    >
                        {item.name}
                    </h2>
                ...
                尚未選擇科目，可選擇後確認，或先略過此項。
                    ...
                    <div className="kbd-hints">
                        ...
                        <span><kbd>← </kbd><kbd> →</kbd> 上 / 下一科目瀏覽</span>
                    </div>
                </div>
            </div>
            ...
            <aside className="quiz-rail">
                ...
                <span
                    className="mono-xs"
                    style={{
                        color: active ? "var(--eagle-primary)" : "var(--fg-muted)",
                        width: 26,
                        flexShrink: 0,
                    }}
                >
